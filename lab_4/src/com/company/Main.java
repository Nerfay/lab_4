...
public class Main {
    ...
    public static void basic () {
        ...
        System.out.println("AmountSellIvanov:" + products.findAmountSellIvanov() + "\n");
        System.out.println("MaxPriceWhoSellIvanov:");
    ...
    public static void advanced () {
        final Collaborator collaborator1 = new Collaborator ("Ivankevich","Ivan","Ivanovich",Position.Administrator,70000,2000 ,12,10 );
        final Collaborator collaborator2 = new Collaborator ("Tabakov","Danya","Danilovich",Position.Boss,110000,1980 ,11,10);
        final Collaborator collaborator3 = new Collaborator ("Ivanov","Kirill","Evgenevich",Position.Newbie,16000,2004 ,3,12);
        ...
        System.out.println();
        System.out.println(collaborators.findYoungerCollaborator());
    }
}
